...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  try {
    ...
    // Filtrer les posts par catégorie "Méthodologie"
    const postsMethodologie = data.data.filter((post: Post) => post.attributes.categorie.data.attributes.nom === 'Methodologie');
...
const Methodologie: React.FC<Props> = ({ posts }) => {
  ...
  return (
    <div css={pageStyles}>
      <Layout>
        <BannerPage title="Méthodologie" color="rgba(229, 7, 73, 1)" /> {/* Couleur personnalisée */}
